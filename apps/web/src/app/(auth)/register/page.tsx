      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                onBlur={(e) => e.target.style.borderColor = '#374151'}
              />
              <p className="mt-2 text-xs text-poke-text-muted">Min 8 characters, 1 uppercase letter, 1 number</p>
            </div>
          ...
          <p className="mt-8 text-center text-poke-text-muted">
            ...
            <Link href="/login" className="text-poke-gold hover:underline font-medium">
              Sign in
            </Link>
          </p>
        </div>
