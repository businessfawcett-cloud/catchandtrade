...
// This endpoint exists for backward compatibility with cached client bundles
// that still call /api/grading/calculate. New code should use /api/grading directly.
